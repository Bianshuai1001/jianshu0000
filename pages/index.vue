                            ...
                            <li class="have-img">
                                ...
                                <div class="content">
                                    ...
                                    <nuxt-link to="/p/123" class="title">
                                        如何把书中知识转化为能力？这是我见过最好的回答
                                    </nuxt-link>
                                    <p class="abstract">
                                        Ⅰ 寂静的夜晚，月光透过窗户悄悄地映在了杰里的身上，
                                        此刻，他正在床上不停地抖动，头也不停地晃动。 “
                                        滚开！” 他惊得从床上弹了起来，他惶恐地环顾了下四周后
                                        ，重重地松了口气，然...
                                    </p>
                                    <div class="meta">
        ...
        data(){
            return {
                ...
                swiperOption: {
                    autoplay:{
                      delay:3000,//切换时间
                      stopOnLastSlide:false,//是否停留在最后一张
                      disableOnInteraction:false,//是否禁止轮播
                    },
                    loop: true,
                    slidesPerView: 'auto',
                    centeredSlides: true,
